  ...
  render() {
    return (
      ...
      <section className='pt-[30px] pb-[150px]'>
        <div className='w-full px-[70px] pb-[100px] flex flex-row justify-between'>
          <div className='w-[49%] border-[1px] border-[#31514D]'>
            <div className='h-fit w-full px-[100px] relative top-[-20px] overflow-hidden'>
              <div id='productImage' className={`relative w-full h-[700px]`}>
          ...
          <div className='flex flex-col w-[49%]'>
            <div className='h-fit w-[90%]'>
              ...
              <div className='flex flex-row justify-between mt-[90px]'>
                <div className={`${poppins.className} w-[49%] flex flex-col text-[15px] leading-[23px]`}>
                ...
                <div className={`${poppins.className} w-[49%]`}>
                  ...
                  <p className='mt-[40%] font-[700] text-[#31514D] text-[12px] leading-[18px] uppercase'>PRICE:<span className='ml-[20px] font-[900] text-[22.4px] text-black leading-[34px]'>$350.00</span></p>
                </div>
              </div>
            </div>
            <div className={`${plus_jakarta_sans.className} font-[600] flex flex-row justify-between mt-[30px]`}>
              <div className='flex flex-row text-[12px] leading-[15px]'>
                <Link href='/checkout'><button className='w-[161px] h-[60px] bg-[#31514D] uppercase text-white'>Check Out</button></Link>
                <Link href='/'><button className='ml-[25px] w-[161px] h-[60px] bg-white uppercase text-[##31514D] border-[1px] border-[#31514D]'>CONTINUE SHOPPING</button></Link>
              </div>
              <button className='border-[1px] border-[#31514D] w-[60px] h-[60px] flex justify-center items-center'>
        ...
        <div className='w-full px-[70px] flex flex-col'>
