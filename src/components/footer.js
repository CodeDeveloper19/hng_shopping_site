...
export default class Footer extends Component {
  render() {
    return (
      <>
        <footer className={`${poppins.className} text-[#FAFAFA] w-full bg-[#31514D] h-fit flex flex-row justify-between px-[70px] py-[70px]`}> 
          <section>
          ...
          <section>
            ...
            <ul className='uppercase leading-[15.12px] text-[12px] mb-[20px]'>
              <li className='uppercase max-w-[390px]'>Stay updated with our latest products, exclusive offers, and design tips.</li>
            </ul>
            <div className={`${plus_jakarta_sans.className} flex flex-row justify-between h-[50px] w-fit`}>
              <input type='email' placeholder='YOUR EMAIL HERE' id='email' className='w-[262px] outline-none leading-[35px] px-[20px] h-full text-[#8787879E] text-[12px]'/>
              <button className='bg-[#740000] hover:bg-[#A52B2B] h-full uppercase px-[20px] ml-[25px] leading-[35px] text-[12px]'>Subscribe</button>
            </div>
          </section>
        </footer>
      </>
